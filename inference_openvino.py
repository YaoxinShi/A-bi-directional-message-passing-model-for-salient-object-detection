...
def main():
    ...
    print("@@@@@@")
    print(res.shape) # (65536, 2)
    print (res)
    print("@@@@@@")

    label_size = w  ## label_size = inference_input_size = wxh = 256x256
    result = np.reshape(res, (label_size, label_size, 2))
    #print("@@@@@@")
    #print(result.shape) # (256, 256, 2)
    #print (result)
    #print("@@@@@@")
    result = result[:, :, 0]
    #print("@@@@@@")
    #print(result.shape) # (256, 256, 1), only pick the first item
    #print (result)
    #print("@@@@@@")
    result = cv2.resize(np.squeeze(result), (original_w, original_h)) ## to 960x540
